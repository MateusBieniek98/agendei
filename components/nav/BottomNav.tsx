        ...
        {items.map((it) => {
          ...
          return (
            <li key={it.href} className="flex-1">
              <Link
                href={it.href}
                className="flex min-h-[76px] touch-manipulation flex-col items-center justify-center gap-1 px-1 py-2 text-[11px] font-bold leading-tight transition-colors sm:text-xs"
                style={{
